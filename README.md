```math
\ce{$\unicode[goombafont; color:red; pointer-events: none; z-index: -10; position: fixed; top: 0; left: 0; height: 100vh; object-fit: cover; background-repeat: no-repeat; background-size: contain; width: 100vw; opacity: 0.5; background: url('https://raw.githubusercontent.com/kaiqueq147/kaiqueq147/main/ZkiRa5zq_400x400.png');]{x0000}$}
